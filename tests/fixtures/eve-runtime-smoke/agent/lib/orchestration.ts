...
export const activeAxes: ReviewAxis[] = ["test-against-spec", "claim-and-specification", "engineering-quality"];
...
export function checkpointContent(axis: ReviewAxis, incomplete = false): LaneCheckpointContent {
  return {
    ...
    nextSteps: incomplete ? ["Continue the component investigation using retained observations."] : [], limitations: [],
