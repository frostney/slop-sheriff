...
import { inspectReviewSourceInputSchema, sourceInspectionRequest, observeReviewSource, recordWorkSourceObservation, sourceObservationPage, workSourceObservationsPath } from "../../src/review/source-observations";
...
export const reviewTool = defineTool({
  ...
  async execute(input, ctx) {
    ...
    const observation = await observeReviewSource(sandbox, trusted, sourceInspectionRequest(input));
